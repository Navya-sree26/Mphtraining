...
public class Employeedao
{
	...
	public void viewEmp()
	{
		...
		public void insertUsingProc(Employee emp)
		{
		...
		public void batchUpdate()
		{
			...
			{
			st=con.createStatement();
			st.addBatch("update mphemp set ename='sreem' where eid=1");
			st.addBatch("update mphemp set ename='praasu' where eid=2");
			st.addBatch("update mphemp set ename='divss' where eid=3");
